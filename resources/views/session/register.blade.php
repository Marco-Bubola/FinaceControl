      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Bem-vindo ao FinanceControl! Gerencie suas finanças e estoque de maneira fácil e segura. Comece agora a acompanhar suas transações e controlar seu inventário sem complicações.</p>
            </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="form-check form-check-info text-left">
                  ...
                  eu concordo o<a href="javascript:;" class="text-dark font-weight-bolder">Terms and Conditions</a>
                  </label>
                  @error('agreement')
                ...
                <p class="text-sm mt-3 mb-0">Já tem uma conta?
                <a href="login" class="text-dark font-weight-bolder">Entrar</a></p>
              </form>
            </div>
          </div>
        </div>
