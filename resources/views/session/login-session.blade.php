...
@section('content')
  ...
  <p class="mb-0">Acesse sua conta para gerenciar suas finanças e estoque.</p>
  <p class="mb-0">Ou crie uma nova conta para começar agora.</p>
</div>
                ...
                <small class="text-muted">Esqueceu sua senha? Redefinir sua senha
                  <a href="/login/forgot-password" class="text-info text-gradient font-weight-bold">aqui</a>
                </small>
                  <p class="mb-4 text-sm mx-auto">
                  Não tem uma conta?
                    <a href="register" class="text-info text-gradient font-weight-bold">Registrar</a>
                  </p>
                </div>
              </div>
            </div>
