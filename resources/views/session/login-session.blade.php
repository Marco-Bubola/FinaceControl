...
@section('content')
    ...
    <main class="main-content mt-0">
        <section>
            <div class="page-header min-vh-85 align-items-start pt-5 ">
                <div class="container ">
                    <div class="ring">
                        ...
                        <div class="login">
                            ...
                            <form role="form" method="POST" action="/session">
                                ...
                                <div class="links">
                                    <a href="/login/forgot-password">Esqueceu sua senha?</a>
...
<style>
    ...
    * {
    ...
    .ring {
        ...
        justify-content: center;
        align-items: center;
        margin-left: 40px; /* Ajustando a margem esquerda */
...
margin-right: 40px;
    ...
    .login {
        ...
        width: 300px;
        height: auto;
        /* Permite que o conteúdo da div ocupe o espaço necessário */
        display: flex;
        justify-content: center;
        align-items: center;
        flex-direction: column;
        ...
        /* Ajusta a posição para um centro perfeito */
