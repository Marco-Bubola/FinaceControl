            ...
            <div class="card-header pb-0">
                <div class="d-flex flex-row justify-content-between">
                    ...
                    <a href="#" class="btn bg-gradient-primary btn-sm mb-0" type="button" data-bs-toggle="modal"
                        data-bs-target="#modalAddUser">+&nbsp; Novo Usuário</a>
                </div>
            </div>
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <img src="{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : 'https://www.gravatar.com/avatar/' . md5($user->email) . '?d=identicon' }}"
