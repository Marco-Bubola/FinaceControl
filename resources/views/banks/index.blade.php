            ...
            <div class="card-header" style="background-color: transparent; border-bottom: none;">
                <div class="row">
                    ...
                    <div class="col-6 text-end">
                        <a class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" data-bs-target="#addCardModal"><i
                                class="fas fa-plus"></i>&nbsp;&nbsp;Adicionar Novo Cartão</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div
                            ...
                            <div class="d-flex flex-column align-items-center">
                                <img class="w-45 me-3 mb-0 " src="{{ $bank->caminho_icone }}" alt="logo">
                    ...
                    <div class="col-12">
                        <div class="d-flex flex-column align-items-center justify-content-center py-3">
                            ...
                            <h2 class="fw-bold mb-2 text-primary"
                                style="font-size:1.3rem; letter-spacing:0.01em; text-shadow:0 2px 8px #e3eafc;">
                                Nenhum Banco ou Cartão Cadastrado
                            </h2>
                            <p class="mb-2 text-secondary text-center"
                                style="max-width: 350px; font-size:1rem; font-weight:500; line-height:1.4;">
                                <span style="color:#0d6efd; font-weight:700;">Ops!</span> Você ainda não cadastrou
                                nenhum método de pagamento.<br>
                                <span style="color:#6ea8fe;">Adicione um novo banco ou cartão</span> para começar a
