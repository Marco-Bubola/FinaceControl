                ...
                <div class="col-md-1 mb-4">
                    <div class="card position-relative h-100">
                        ...
                        <div class="position-absolute top-0 end-0 p-2">
                            <a href="javascript:void(0)" class="btn btn-primary btn-sm p-1 btn-edit-product"
                            ...
                            <button type="button" class="btn btn-danger btn-sm p-1 btn-delete-product"
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="text-center"><strong>Preço Unitário:</strong> R$ {{ number_format($item->price_sale, 2, ',', '.') }}
                            <p class="text-center"><strong>Preço Total:</strong> R$ {{ number_format($item->price_sale * $item->quantity, 2, ',', '.') }}</p>
...
<div class="modal fade" id="modalEditProduct" tabindex="-1" aria-labelledby="modalEditProductLabel" aria-hidden="true" data-sale-id="{{ $sale->id }}">
            ...
            <div class="modal-body">
                <form id="form-edit-product" action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" name="price_sale" id="price_edit" class="form-control" required>
                    </div>
