                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">R$
                                        {{ number_format($sale->total_price - $sale->amount_paid, 2, ',', '.') }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <div class="col-md-1 mb-4">
                            <div class="card position-relative h-100">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <p class="card-text text-center text-truncate" style="max-width: 250px;">
                                        {{ $item->product->description }}</p>
                                    <p class="text-center"><strong>Quantidade:</strong> {{ $item->quantity }}</p>
                                    <p class="text-center"><strong>Preço Unitário:</strong> R$
                                        {{ number_format($item->price_sale, 2, ',', '.') }}
                                    <p class="text-center"><strong>Preço Total:</strong> R$
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Tem certeza de que deseja excluir este pagamento de R$
                            {{ number_format($payment->amount_paid, 2, ',', '.') }}?</p>
                    </div>
                    <div class="modal-footer">
