...
<div class="container-fluid py-4 custom-invoice-container">
    ...
    <!-- Exibir sucesso -->
    @if (session('success'))
    <div id="success-message" class="alert alert-success alert-dismissible fade show custom-success-message" role="alert">
        {{ session('success') }}
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"
    ...
    <div class="row">
        ...
        <div class="col-md-7 custom-card-info">
                ...
                <div class="overflow-hidden position-relative border-radius-xl"
                    ...
                    <div class="card-body position-relative z-index-1 p-4">
                        <div class="d-flex justify-content-between align-items-start mb-4">
                            ...
                            <img class="w-25 border-radius-lg shadow-sm" src="../assets/img/logos/mastercard.png" alt="logo">
                        </div>
                        <!-- Resumo do Mês -->
                        <div class="mt-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="text-success text-sm font-weight-bold" id="total-invoices">R$ {{ number_format($totalInvoices, 2) }}</span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="text-info text-sm font-weight-bold" id="total-transactions">{{ $totalTransactions }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Calendário -->
            <div class="card bg-transparent shadow-xl mt-4 custom-calendar-card">
                <div class="overflow-hidden position-relative border-radius-xl"
                    style="background-image: url('../assets/img/curved-images/curved14.jpg');">
                    <span class="mask bg-gradient-dark"></span>
                    <div class="card-body position-relative z-index-1 p-4">
                        <div class="d-flex align-items-center mb-4">
                            <i class="fas fa-calendar-alt text-white p-2 me-3" style="font-size: 24px;"></i>
                            <h5 class="text-white mb-0">Calendário</h5>
                        </div>
            ...
            <div class="card h-100 mb-4 custom-transactions-card">
                <div class="card-header pb-0 px-3">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12 d-flex justify-content-between align-items-center">
                            <a href="#" id="previous-month" class="btn btn-outline-secondary btn-sm btn-change-month" data-month="{{ $previousMonth }}">
                                <i class="fas fa-chevron-left me-1"></i> Mês Anterior
                            </a>
                            <a href="#" id="next-month" class="btn btn-outline-secondary btn-sm btn-change-month" data-month="{{ $nextMonth }}">
                ...
                <div class="card-body pt-4 p-3">
                    <h6 id="current-month-title" class="text-uppercase text-body text-xs font-weight-bolder mb-3">
                        {{ $currentMonthName }} ({{ $currentStartDate->format('d/m/Y') }} - {{ $currentEndDate->format('d/m/Y') }})
                    </h6>
...
<script>
    $(document).ready(function() {
        ...
        $('#calendar').fullCalendar({
            ...
            // Estilização para garantir que os dias fora do mês atual sejam funcionais
            dayRender: function(date, cell) {
                if (!date.isSame(date, 'month')) {
                    cell.css('opacity', '1'); // Remove o efeito de desativação
                    cell.css('background-color', '#ffffff'); // Garante que o fundo seja branco
                    cell.addClass('fc-other-month'); // Adiciona uma classe para estilização
                }
            },
